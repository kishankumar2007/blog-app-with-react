...
function Post() {
  ...
  return (
    <div className='w-full min-h-screen sm:p-10 p-5'>
      {post?.userId === userData?.$id && <div className='flex gap-3 top-18 sm:text-sm text-xs lg:right-50 right-2 absolute sm:right-15'><button onClick={editPost} className='rounded bg-emerald-500 text-white p-1 sm:p-2'>📝Edit</button> <button onClick={deletePost} className='rounded bg-red-600 text-white p-1 sm:p-2'> 🗑️ Delete</button></div>}
