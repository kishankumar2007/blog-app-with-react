...
const Navbar = () => {
  ...
  return (
    <nav className="bg-slate-900 shadow-md w-full p-4 md:px-35">
      ...
      <div className={`menu ${isClicked ? 'top-0' : '-top-full'} sm:hidden transition-all ease duration-500 ease-in-out absolute flex pt-5 flex-col w-screen items-center bg-slate-900 left-0 right-0`}>
